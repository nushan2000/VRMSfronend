...
export default function ReservationDash({updateTrigger}) {
    ...
    async function fetchReserDetail() {
      ...
      console.log(response);
        ...
        const filteredRequests = response.data.filter(request =>  request.approveHead &&!request.approveChecker && !request.approveDeenAr && !request.approveDeen &&request.driverStatus!=="reject"&& request.driverStatus!=="approved");
